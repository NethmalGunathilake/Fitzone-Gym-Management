...
if (!isset($_GET['id']) || empty($_GET['id'])) {
    header("Location: staff_nutrition.php");
    exit();
}
...
<head>
    ...
    <title><?php echo htmlspecialchars($guide['title']); ?> | FitZone Staff</title>
            ...
            <div class="content-area">
                ...
                <div class="nutrition-detail-container">
                    ...
                    <div class="nutrition-actions">
                        <?php if($guide['created_by'] == $user_id): ?>
                        <a href="staff_edit_nutrition.php?id=<?php echo $guide['id']; ?>" class="btn btn-primary">
                            <i class='bx bx-edit'></i> Edit Guide
                        </a>
                        <?php endif; ?>
                        <a href="staff_nutrition.php" class="btn btn-secondary">
